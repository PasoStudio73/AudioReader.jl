...
@testset "against matlab" begin
    ...
    a911_wav = AudioReader.load(wav_file, format=Float64)
    wav_data_a911 = AudioReader.get_data(a911_wav)
    ...
    a911_mp3 = AudioReader.load(mp3_file, mono=false)
    mp3_data_a911 = AudioReader.get_data(a911_mp3)
