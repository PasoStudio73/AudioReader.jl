...
[![stable](https://img.shields.io/badge/docs-stable-blue.svg)](https://PasoStudio73.github.io/AudioReader.jl/stable)
...
- **FileIO.jl**: Provides the file format detection and unified I/O interface
  - Gunther, S., et al. (2016). FileIO.jl. [github.com/JuliaIO/FileIO.jl](https://github.com/JuliaIO/FileIO.jl)
  
- **libsndfile_jll.jl**: Julia bindings for libsndfile C library (lossless audio formats)
  - Erikd, E. (2021). libsndfile. [libsndfile.github.io/libsndfile/](http://libsndfile.github.io/libsndfile/)
  - JLL wrapper: [github.com/JuliaBinaryWrappers/libsndfile_jll.jl](https://github.com/JuliaBinaryWrappers/libsndfile_jll.jl)
  
- **mpg123_jll.jl**: Julia bindings for mpg123 C library (MP3 and other lossy formats)
  - Taschner, M., et al. mpg123. [www.mpg123.de/](https://www.mpg123.de/)
  - JLL wrapper: [github.com/JuliaBinaryWrappers/mpg123_jll.jl](https://github.com/JuliaBinaryWrappers/mpg123_jll.jl)

- **DSP.jl**: Digital signal processing for resampling operations
  - JuliaDSP contributors. DSP.jl. [github.com/JuliaDSP/DSP.jl](https://github.com/JuliaDSP/DSP.jl)
